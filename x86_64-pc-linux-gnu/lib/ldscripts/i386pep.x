...
SEARCH_DIR("/run/media/hilledkinged/Projects/tc-build/kek/x86_64-pep/lib"); SEARCH_DIR("/run/media/hilledkinged/Projects/tc-build/kek/lib"); SEARCH_DIR("/usr/local/lib"); SEARCH_DIR("/lib"); SEARCH_DIR("/usr/lib");
SECTIONS
{
